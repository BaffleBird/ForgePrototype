...
public class SP_DefenseState : PlayerState
{
	public float currentSpeed = 0f;
	float brakeSpeed = 0.3f;

	float parryLength = 0.19f;
	float parryTime = 0f;

	float effectLength = 0.1f;
	float effectTime = 0f;
	...
	public SP_DefenseState(PlayerControl playerController) : base(playerController) { stateName = "Defense"; }
