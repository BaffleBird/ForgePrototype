...
public class UA_DefenseState : PlayerState
{
	public float currentSpeed = 0f;
	float brakeSpeed = 0.3f;

	float parryLength = 0.17f;
	float parryTime = 0f;

	float effectLength = 0.17f;
	float effectTime = 0f;
	...
	public UA_DefenseState(PlayerControl playerController) : base(playerController) { stateName = "Defense"; }
