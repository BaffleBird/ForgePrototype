...
public class SP_StrongAttackState : PlayerState
{
	float fullMove = 7f;
	...
	public SP_StrongAttackState(PlayerControl playerController) : base(playerController) { stateName = "Strong Attack"; }
	...
	void SpawnStrongAttack()
	{
		...
		attack.SetAnchor(playerControl.rigidBody, attackDirection, 0.6f, 0.5f);
		attack.attackStep = 5;
	}
}
