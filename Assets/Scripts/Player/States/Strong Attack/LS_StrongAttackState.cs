...
public class LS_StrongAttackState : PlayerState
{
	float fullMove = 5.5f;
	...
	public LS_StrongAttackState(PlayerControl playerController) : base(playerController) { stateName = "Strong Attack"; }
	...
	void SpawnStrongAttack( int i)
	{
		...
		attack.SetAnchor(playerControl.rigidBody, attackDirection, 0.1f, 0.5f);
